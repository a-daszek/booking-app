...
export const addMyHotel = async (hotelFormData: FormData) => {
  ...
  if (!response.ok) {
    throw new Error("Nie udało się dodać hotelu.");
  }
  return response.json();
};
...
export const fetchMyHotelById = async (hotelId: string): Promise<HotelType> => {
  ...
  if (!response.ok) {
    throw new Error("Wystąpił błąd przy pobieraniu danych o hotelach.");
  }
...
export const updateMyHotelById = async (hotelFormData: FormData) => {
  ...
  if (!response.ok) {
    throw new Error("Nie udało się zaktualizować hotelu.");
  }
...
export type SearchParams = {
  //queryparams have to be of type string
  destination?: string;
  checkIn?: string;
  checkOut?: string;
  adultCount?: string;
...
export const createRoomBooking = async (formData: BookingFormData) => {
  ...
  if (!response.ok) {
    throw new Error("Wystąpił błąd przy rezerwacji");
  }
};
...
export const fetchMyBookings = async (): Promise<HotelType[]> => {
  ...
  if (!response.ok) {
    throw new Error("Nie udało się pobrać danych o rezerwacjach");
  }
